...
'ldap_location_help'             => 'The LDAP Location field should be used if <strong>an OU is not being used in the Base Bind DN.</strong> Leave this blank if an OU search is being used.',
    ...
    'show_images_in_email_help'   => 'Poista tämä valinta, jos AMS asennus on toteutettu VPN: n avulla tai suljetussa verkossa, koska sähköposteissa käytetyt kuvat eivät voi latautua näkyviin sähköposteissa.',
    ...
    'snipe_version'  			=> 'AMS versio',
    'support_footer'            => 'Tuki-alatunnisteen linkit ',
    'support_footer_help'       => 'Määrittele, kuka voi nähdä linkit AMS tukipalvelun tietoihin ja käyttöohjeeseen',
    'version_footer'            => 'Versio alatunnisteessa ',
    'version_footer_help'       => 'Määrittele, kuka näkee AMS järjestelmän version ja käännöksen numeron.',
    ...
    'width_w'        => 'l',
    'height_h'        => 'k',
    'show_url_in_emails'                => 'Linkki AMS: hen sähköposteissa',
    'show_url_in_emails_help_text'      => 'Poista tämä valintaruutu, jos et halua linkata takaisin AMS-asennukseen sähköpostin alatunnisteisiin. Hyödyllinen, jos useimmat käyttäjät eivät koskaan kirjaudu sisään.',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Tämä yrittää poistaa välimuistissa olevat viivakoodit. Tätä käytetään yleensä vain, jos viivakoodisi asetukset ovat muuttuneet, tai jos AMS URL on muuttunut. Viivakoodit luodaan uudelleen, kun niitä käytetään seuraavaksi.',
