...
return [
    ...
    'login' => 'Вхід',
    'login_first_admin' => 'Увійдіть до вашої нової установки AMS за допомогою нижче:',
    ...
    'snipe_webhook_test' => 'Тест інтеграції AMS',
    'snipe_webhook_summary' => 'Підсумок інтеграції AMS',
    'supplier' => 'Постачальник',
    'tag' => 'Тег',
    'test_email' => 'Тестовий електронний лист зі AMS',
    'test_mail_text' => 'Це тест з системи управління активами AMS. Якщо ви отримали, пошта працює :)',
    ...
    'your_credentials' => 'Ваші облікові дані AMS',
