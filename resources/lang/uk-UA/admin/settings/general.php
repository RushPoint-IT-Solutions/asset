...
'ldap_location_help'             => 'The LDAP Location field should be used if <strong>an OU is not being used in the Base Bind DN.</strong> Leave this blank if an OU search is being used.',
    ...
    'load_remote_help_text'		=> 'Зніміть цей прапорець, якщо інсталяція не може завантажити скрипти з зовнішнього Інтернету. Це не дозволить AMS спробувати завантажити аватари з Gravatar або інших зовнішні джерела.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Якщо вказано посилання, користувачі будуть перенаправлені на цей URL після виходу з AMS. Це корисно для коректного закриття користувацьких сеансів вашого провайдера автентифікації.',
    ...
    'show_images_in_email_help'   => 'Зніміть цей прапорець, якщо інсталяція AMS розташована за VPN або закритою мережею, і користувачі за межами мережі не зможуть завантажувати зображення, які обслуговуються з цієї інсталяції у своїх листах.',
    ...
    'snipe_version'  			=> 'Версія AMS',
    'support_footer'            => 'Підтримка посилань в футері ',
    'support_footer_help'       => 'Вкажіть, хто бачить посилання на інформацію підтримки AMS та посібник користувача',
    'version_footer'            => 'Версія в футері ',
    'version_footer_help'       => 'Вкажіть, хто бачить версію AMS і номер збірки.',
    ...
    'width_w'        => 'т',
    'height_h'        => 'г',
    'show_url_in_emails'                => 'Посилання на AMS в E-mail-адресах',
    'show_url_in_emails_help_text'      => 'Зніміть цей прапорець, якщо ви не хочете вказувати посилання на встановлення AMS у футерах електронної пошти. Корисно, якщо більшість з ваших користувачів ніколи не увійшли. ',
    'text_pt'        => 'бал',
    ...
    'barcodes_help' => 'Це спробує видалити кешовані коди. Це зазвичай, буде використано, лише якщо змінилися налаштування штрих-коду або якщо ваша URL-адреса AMS змінилася. Код штрих-кодів буде повторно створено при доступі до наступного.',
