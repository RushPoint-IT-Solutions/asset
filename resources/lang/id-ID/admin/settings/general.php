...
'ldap_location_help'             => 'The LDAP Location field should be used if <strong>an OU is not being used in the Base Bind DN.</strong> Leave this blank if an OU search is being used.',
    ...
    'load_remote_help_text'		=> 'Hapus centang kotak ini jika instalasi Anda tidak dapat memuat skrip dari internet eksternal. Ini akan mencegah AMS mencoba memuat avatar dari Gravatar atau sumber eksternal lainnya.',
    ...
    'show_images_in_email_help'   => 'Hapus centang kotak ini jika instalasi AMS Anda berada di belakang VPN atau jaringan tertutup dan pengguna di luar jaringan tidak akan dapat memuat gambar yang disajikan dari instalasi ini di email mereka.',
    ...
    'snipe_version'  			=> 'Versi AMS',
    'support_footer'            => 'Mendukung Footer Links ',
    'support_footer_help'       => 'Tentukan siapa yang melihat tautan ke info Dukungan AMS dan Panduan Pengguna',
    'version_footer'            => 'Versi pada Footer ',
    'version_footer_help'       => 'Tentukan siapa saja yang dapat melihat versi dan build number dari AMS.',
    ...
    'width_w'        => 'l',
    'height_h'        => 't',
    'show_url_in_emails'                => 'Tautan ke AMS di Email',
    'show_url_in_emails_help_text'      => 'Hapus centang pada kotak ini jika Anda tidak ingin menautkan kembali ke instalasi AMS Anda di footer email Anda. Berguna jika sebagian besar pengguna Anda tidak pernah masuk.',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Ini akan mencoba menghapus barcode yang di-cache. Ini biasanya hanya digunakan jika pengaturan barcode Anda telah berubah, atau jika URL AMS Anda telah berubah. Barcode akan dibuat ulang saat diakses berikutnya.',
...
<br>Perhatikan bahwa nilai barcode harus mematuhi spesifikasi barcode terkait agar berhasil diger. Silakan lihat <a href="https://AMS.readme.io/docs/barcodes">dokumentasi <i class="fa fa-external-link"></i></a> untuk detail lebih lanjut. ',
    'asset_id'              => 'ID Aset',
    'data'               => 'Data',
    'default'               => 'Default',
    'none'                  => 'Kosong',
