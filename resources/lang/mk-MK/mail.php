...
return [
    ...
    'login' => 'Најава',
    'login_first_admin' => 'Влезете во новата инсталација на AMS користејќи ги ингеренциите подолу:',
    ...
    'serial' => 'Сериски',
    'snipe_webhook_test' => 'AMS Тест за интеграција',
    'snipe_webhook_summary' => 'AMS Резиме на тест за интеграција',
    'supplier' => 'Добавувач',
    'tag' => 'Таг',
    'test_email' => 'Тест е-пошта од AMS',
    'test_mail_text' => 'Ова е тест од AMS Системот за управување со основни средства. Ако го добивте ова, е-поштата работи :)',
