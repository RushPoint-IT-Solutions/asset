...
return [
    ...
    'importing_help'        => 'Das CSV sollte kommagetrennt und mit Headern formatiert werden, die mit den in der <a href="https://AMS.readme.io/docs/importing" target="_new">Beispiel-CSVs in der Dokumentation</a> übereinstimmen.',
    ...
    'webhook_test_msg'        => 'Oh hi! Sieht so aus, als ob Deine :app Integration mit AMS funktioniert!',
    ...
    'footer_credit' => '<a target="_blank" href="https://snipeitapp.com" rel="noopener">AMS</a> ist Open-Source-Software, entwickelt mit <i class="fa fa-heart" aria-hidden="true" style="color: #a94442; font-size: 10px" /></i><span class="sr-only">Liebe</span> von <a href="https://bsky.app/profile/snipeitapp.com" rel="noopener">@snipeitapp.com</a>.',
