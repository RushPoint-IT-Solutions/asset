...
'ldap_location_help'             => 'The LDAP Location field should be used if <strong>an OU is not being used in the Base Bind DN.</strong> Leave this blank if an OU search is being used.',
    ...
    'load_remote_help_text'		=> 'Deaktiviere dieses Kästchen, wenn deine Installation keine Skripte aus dem externen Internet laden kann. Das verhindert, dass AMS versucht, Bilder von Gravatar oder anderen externen Quellen zu laden.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Sofern hier eine URL angegeben ist, werden Benutzer automatisch zu dieser URL weitergeleitet, nachdem der Benutzer sich aus AMS ausloggt. Dies ist nützlich, um die Benutzersitzung Deines Authentifizierungsproviders korrekt zu beenden.',
    ...
    'show_images_in_email_help'   => 'Deaktiviere dieses Kästchen, wenn sich Deine AMS-Installation hinter einem VPN oder einem geschlossenen Netzwerk befindet und Benutzer außerhalb des Netzwerks keine Bilder von dieser Installation in ihren E-Mails laden können.',
    ...
    'support_footer_help'       => 'Lege fest, wer die Links zu AMS Support-Information und Benutzerhandbuch sieht',
    'version_footer'            => 'Version in in der Fußzeile ',
    'version_footer_help'       => 'Lege fest, wer die AMS-Version- und Build-Nummer sieht.',
    ...
    'show_url_in_emails_help_text'      => 'Deaktiviere dieses Kästchen, wenn du nicht auf deine AMS-Installation in deinen E-Mail-Fußzeilen verlinken möchtest. Nützlich, wenn sich die meisten Nutzer nie anmelden. ',
    'text_pt'        => 'pkt',
    ...
    'barcodes_help' => 'Dies wird versuchen, zwischengespeicherte Barcodes zu löschen. Dies wird in der Regel nur verwendet werden, wenn sich die Barcode-Einstellungen geändert haben oder sich Deine AMS-URL geändert hat. Barcodes werden beim nächsten Zugriff neu generiert.',
    ...
    'help_default_will_use' => '<code>:default</code> verwendet den Wert von <code>:setting_name</code>. <br>Beachte, dass der Wert der Barcodes mit der jeweiligen Strichcode-Spezifikation übereinstimmen muss, um erfolgreich generiert zu werden. Bitte lese <a href="https://AMS.readme.io/docs/barcodes">die Dokumentation <i class="fa fa-external-link"></i></a> für weitere Details. ',
    'asset_id'              => 'Asset-ID',
    'data'               => 'Daten',
    'default'               => 'Standard',
    'none'                  => 'Nichts',
