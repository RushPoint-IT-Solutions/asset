...
return [
    ...
    'login' => 'Логин',
    'login_first_admin' => 'Влезте в своята AMS инсталация използвайки данните по-долу:',
    ...
    'snipe_webhook_test' => 'AMS Интеграционен тест',
    'snipe_webhook_summary' => 'AMS Резюме на интеграционния тест',
    'supplier' => 'Доставчик',
    'tag' => 'Етикет',
    'test_email' => 'Тест Email от AMS',
    'test_mail_text' => 'Това е тест от AMS система за управление на активи. Ако сте получили това, email-а работи :)',
    ...
    'your_credentials' => 'Вашите идентификационни данни за AMS',
