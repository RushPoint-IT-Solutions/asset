...
'ldap_location_help'             => 'The LDAP Location field should be used if <strong>an OU is not being used in the Base Bind DN.</strong> Leave this blank if an OU search is being used.',
    ...
    'load_remote_help_text'		=> 'Премахнете отметката от това квадратче, ако вашата инсталация не може да зареди скриптове от външен интернет. Това ще попречи на AMS да се опита да зареди аватари от Gravatar или други външни източници.',
    'login'                     => 'Опити за вход',
    ...
    'login_remote_user_custom_logout_url_help' => 'Ако уеб адреса е вписън тук, потребителите ще бъдат препратени към този URL след като излязат от AMS. Това е препоръчително за да се затвори сесията от доставчика на удостоверения правилно.',
    ...
    'snipe_version'  			=> 'AMS версия',
    'support_footer'            => 'Връзки към AMS поддръжката във футъра',
    'support_footer_help'       => 'Указва визуализацията на връзки към поддръжката на AMS и потребителската документация',
    'version_footer'            => 'Версия в долен колонтитул ',
    'version_footer_help'       => 'Определя кой ще вижда AMS версията и номера на компилация.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Връзка към AMS в имейли',
    'show_url_in_emails_help_text'      => 'Премахнете отметката от тази кутийка, ако не желаете да свържете обратно към вашата AMS инсталация в досиетата ви за електронна поща. Полезно, ако повечето от вашите потребители никога не влизат в системата.',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Това ще изтрие кеша на баркодовете. Това обикновено се използва при промяна на баркод настройките или при промяна на AMS URL адреса. Баркодовете ще бъдат генерирани отново.',
