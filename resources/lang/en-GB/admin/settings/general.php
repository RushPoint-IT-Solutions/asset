...
'ldap_location_help'             => 'The LDAP Location field should be used if <strong>an OU is not being used in the Base Bind DN.</strong> Leave this blank if an OU search is being used.',
    ...
    'login_remote_user_custom_logout_url_help' => 'If a url is provided here, users will be redirected to this URL after the user logs out of AMS. This is useful to close the user sessions of your Authentication provider correctly.',
    ...
    'version_footer_help'       => 'Specify who can see the AMS version and build number.',
