...
'ldap_location_help'             => 'Il campo Posizione LDAP deve essere usato se <strong>una OU non viene utilizzata nella Base Bind DN</strong> Lascia vuoto se viene usata la ricerca OU.',
    ...
    'ldap_display_name_help'    => 'Se hai un campo displayName separato nel tuo LDAP/AD, mappa qui e verrà utilizzato per mostrare gli utenti in AMS.',
    ...
    'load_remote_help_text'		=> 'Deseleziona questa casella se la tua installazione non può caricare gli script dall\'esterno. Questo impedirà a AMS di provare il caricamento degli avatar da Gravatar o da altre fonti esterne.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Se qui viene indicato un URL, gli utenti verranno reindirizzato a questo URL dopo essere usciti da AMS. Questo è utile per chiudere correttamente le sessioni dell\'utente.',
    ...
    'show_images_in_email_help'   => 'Deseleziona questa casella se l\'installazione di AMS si trova dietro una rete VPN o chiusa e gli utenti esterni alla rete non saranno in grado di caricare le immagini fornite da questa installazione nelle loro e-mail.',
    'site_name'                 => 'Nome sito',
    ...
    'support_footer_help'       => 'Specificare chi vede i collegamenti alle informazioni sul supporto IT e su AMS',
    'version_footer'            => 'Versione a piè di pagina ',
    'version_footer_help'       => 'Specifica chi può vedere la versione di AMS e il numero di build.',
    ...
    'width_w'        => 'l',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Collegamento a AMS in posta elettronica',
    'show_url_in_emails_help_text'      => 'Deseleziona questa casella se non si desidera collegare nuovamente all\'installazione AMS nei piè di pagina di posta elettronica. Utile se la maggior parte dei tuoi utenti non entra mai in login.',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Ciò eliminerà i codici a barre nella cache, utilizzato di solito se le impostazioni dei codici a barre sono cambiate, o se l\'URL di AMS è cambiato. I codici a barre saranno ri-generati alla prossima richiesta.',
