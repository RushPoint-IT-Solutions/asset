...
return [
    ...
    'login' => 'ログイン',
    'login_first_admin' => '以下の新しいログイン情報を使用して、AMSにログインします。',
    ...
    'serial' => 'シリアル',
    'snipe_webhook_test' => 'AMS 統合テスト',
    'snipe_webhook_summary' => 'AMS 統合テストの概要',
    'supplier' => '仕入先',
    'tag' => 'タグ',
    'test_email' => 'AMSからのテストメール',
    'test_mail_text' => 'これはAMS資産管理システムのテストです。あなたがこれを読めているなら、メール機能は動作しています:)',
