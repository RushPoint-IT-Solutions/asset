...
return [
    ...
    'importing_help'        => 'CSV-файл должен быть разделён запятыми и отформатирован с заголовками, соответствующими заголовкам в <a href="https://AMS.readme.io/docs/importing" target="_new">примерах CSV-файлов из документации</a>.',
    ...
    'webhook_test_msg'        => 'О, привет! Похоже, что ваша интеграция :app с AMS работает!',
    ...
    'footer_credit' => '<a target="_blank" href="https://snipeitapp.com" rel="noopener">AMS</a> - это программное обеспечение с открытым исходным кодом, созданное с <i class="fa fa-heart" aria-hidden="true" style="color: #a94442; font-size: 10px" /></i><span class="sr-only">любовью</span> командой <a href="https://bsky.app/profile/snipeitapp.com" rel="noopener">@snipeitapp.com</a>.',
