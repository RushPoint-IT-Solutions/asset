...
'ldap_location_help'             => 'Az LDAP Location mezőt akkor kell használni, ha <strong>az OU nincs használatban a Base Bind DN-ben.</strong> Ezt hagyd üresen, ha OU keresést használsz.',
    ...
    'ldap_display_name_help'    => 'Ha van külön displayName mező az LDAP/AD rendszeredben, térképezd ide, és azt fogja használni a AMS a felhasználók megjelenítéséhez.',
    ...
    'load_remote_help_text'		=> 'Vedd ki a pipát ebből a négyzetből, ha a telepítésed nem tud külső internetes forrásokból szkripteket betölteni. Ez megakadályozza, hogy a AMS megpróbálja az avatarokat a Gravatarról vagy más külső forrásokból betölteni.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Ha megad itt egy URL-t, a felhasználók a AMS-ből való kilépéskor át lesznek irányítva a megadott URL-re. Ez hasznos lehet a hitelesítés szolgáltatónál meglévő felhasználói munkamenet megfelelő lezárására.',
    ...
    'show_images_in_email_help'   => 'Vegye ki a jelölést innen, ha az Ön AMS alkalmazása VPN mögött, vagy zárt hálózaton található, és a felhasználók a hálózaton kívül nem tudják az emailekben megjeleníteni az alkalmazás által szolgáltatott képeket.',
    ...
    'snipe_version'  			=> 'AMS változat',
    'support_footer'            => 'Lábjegyzet linkek támogatása ',
    'support_footer_help'       => 'Adja meg, hogy ki láthassa a AMS támogatási információ és a felhasználói kézikönyv linkjeit',
    'version_footer'            => 'Verzió a láblécben ',
    'version_footer_help'       => 'Határozza meg, hogy ki láthassa a AMS verzió és build adatokat.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Link a AMS-re az e-mailekben',
    'show_url_in_emails_help_text'      => 'Törölje a jelet a jelölőnégyzetből, ha nem kíván visszaváltani a AMS telepítéséhez az e-mail láblécében. Hasznos ha a legtöbb felhasználó soha nem jelentkezik be.',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Ez megpróbálja törölni a gyorsítótárazott vonalkódokat. Ezt általában csak akkor használja, ha a vonalkód beállításai megváltoztak, vagy ha a AMS URL címe megváltozott. A vonalkódok a következő eléréskor újra generálásra kerülnek.',
    ...
    'label2_title'            => 'Cím',
    'label2_title_help'       => 'A cím, amely megjelenik azoknál a címkéknél, amelyek támogatják',
    ...
    'help_default_will_use' => 'A <code>:default</code> a <code>:setting_name</code> értékét fogja használni. <br>Ne feledje, hogy a vonalkódok értékének meg kell felelnie a megfelelő vonalkód-specifikációnak ahhoz, hogy sikeresen generálhatóak legyenek. További részletekért tekintse meg a <a href="https://AMS.readme.io/docs/barcodes">dokumentációt <i class="fa fa-external-link"></i></a> ',
