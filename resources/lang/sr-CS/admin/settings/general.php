...
'ldap_location_help'             => 'LDAP Polje lokacije bi trebalo koristiti ukoliko se <strong>OU ne koristi u DN za korensko povezivanje.</strong> Ostavite prazno ukoliko se koristi OU pretraga.',
    ...
    'ldap_display_name_help'    => 'Ako imate odvojeno displayName polje u vašem LDAP/AD-u, mapirajte ga ovde i biće korišćeno za prikazivanje korisnika u AMS.',
    ...
    'load_remote_help_text'		=> 'Isključi ovo polje ako tvoja instalacija ne može da učita skripte sa spoljnog interneta. Ovo će sprečiti AMS od pokušaja da učita slike sa Gravatara ili drugih spoljnih izvora.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Ako se ovde navede url, korisnici će biti preusmereni na ovu URL adresu nakon što se korisnik odjavi sa AMS-a. Ovo je korisno za pravilno zatvaranje korisničkih sesija vašeg dobavljača autentikacije.',
    ...
    'show_images_in_email_help'   => 'Poništite izbor u ovom polju za potvrdu ako je vaša AMS instalacija iza VPN-a ili zatvorene mreže i korisnici van mreže neće moći da učitavaju slike koje se serviraju iz ove instalacije u svoje imejlove.',
    ...
    'snipe_version'  			=> 'AMS verzija',
    'support_footer'            => 'Podška za linkove u podnožju ',
    'support_footer_help'       => 'Navedite ko vidi veze do informacija o podršci za AMS i korisničkog priručnika',
    'version_footer'            => 'Verzija u podnožju ',
    'version_footer_help'       => 'Navedite ko vidi verziju AMS-a i broj verzije.',
    ...
    'width_w'        => 'š',
    'height_h'        => 'v',
    'show_url_in_emails'                => 'Link ka AMS in emailovima',
    'show_url_in_emails_help_text'      => 'Poništite izbor u ovom polju za potvrdu ako ne želite da se vratite na svoju AMS instalaciju u podnožju e-pošte. Korisno ako se većina vaših korisnika nikada ne prijavi. ',
    'text_pt'        => 'pt',
