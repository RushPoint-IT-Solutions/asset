...
'ldap_location_help'             => 'El campo Location (ubicación) de Ldap debe utilizarse si <strong>una OU no está siendo utilizada en el Base Bind DN (DN del enlace base).</strong> Deje este espacio en blanco si se utiliza una búsqueda OU.',
    ...
    'ldap_display_name_help'    => 'Si tiene un campo displayName separado en su LDAP/AD, lo mapeará aquí y se utilizará para mostrar usuarios dentro de AMS.',
    ...
    'load_remote_help_text'		=> 'Desmarque esta casilla si su instalación no puede cargar secuencias de comandos (scripts) desde Internet . Esto evitará que AMS intente cargar avatares de Gravatar u otras fuentes externas.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Si se proporciona una URL aquí, los usuarios serán redirigidos a esta URL después de que el usuario cierre la sesión de AMS. Esto es útil para cerrar correctamente las sesiones de usuario de su proveedor de autenticación.',
    ...
    'show_images_in_email_help'   => 'Desmarque esta casilla si su instalación de AMS está detrás de una red privada o VPN y los usuarios fuera de la red no pueden cargar las imágenes publicadas desde este servidor de AMS en sus correos electrónicos.',
    ...
    'snipe_version'  			=> 'Versión de AMS',
    'support_footer'            => 'Enlace al soporte en el pie de página ',
    'support_footer_help'       => 'Especifique quién puede ver los enlaces a la información de soporte de AMS y al manual de usuario.',
    'version_footer'            => 'Versión en el pie de página ',
    'version_footer_help'       => 'Especifique quién puede ver la versión de AMS y el número de compilación.',
    ...
    'width_w'        => 'ancho',
    'height_h'        => 'alto',
    'show_url_in_emails'                => 'Enlace a AMS en correos electrónicos',
    'show_url_in_emails_help_text'      => 'Desmarque esta casilla si no desea vincular su instalación de AMS en el pie de página de correo electrónico. Útil si la mayoría de sus usuarios nunca se conectan. ',
    'text_pt'        => 'puntos',
    ...
    'barcodes_help' => 'Esto intentará eliminar códigos de barras almacenados en caché. Normalmente solo se usa si la configuración del código de barras ha cambiado o si ha cambiado la URL de AMS. Los códigos de barras se volverán a generar la próxima vez que se acceda a ellos.',
