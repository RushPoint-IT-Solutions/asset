...
'ldap_location_help'             => 'Lauką „LDAP Vieta“ reikia naudoti, kai <strong>OU paieška nėra atliekama pagrindiniame susiejimo DN (Base Bind DN).</strong> Palikite šį lauką tuščią, jei naudojate OU paiešką.',
    ...
    'load_remote_help_text'		=> 'Atžymėkite šį langelį, jei jūsų diegimas negali vykdyti skriptų iš interneto. Tai neleis „AMS“ bandyti įkelti avatarų iš „Gravatar“ ar kitų išorinių šaltinių.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Jei čia yra pateiktas adresas, į jį bus nukreipti naudotojai po to, kai atsijungs nuo „AMS“. Tai naudinga norint tinkamai uždaryti autentifikuotų naudotojų sesijas.',
    ...
    'show_images_in_email_help'   => 'Nuimkite žymelę jeigu jūsų AMS diegimas yra už VPN arba uždarame tinkle, kitaip tinkle nesantys išorės naudotojai negalės matyti el. laiškuose pateiktų atvaizdų.',
    ...
    'snipe_version'  			=> 'AMS versija',
    'support_footer'            => 'Palaikymo nuorodos poraštėje ',
    'support_footer_help'       => 'Nurodykite, kas mato nuorodas į AMS palaikymo informaciją ir naudotojo vadovą',
    'version_footer'            => 'Versijos rodymas poraštėje ',
    'version_footer_help'       => 'Nurodykite, kas mato AMS versiją ir darinio (build) numerį.',
    ...
    'width_w'        => 'p',
    'height_h'        => 'a',
    'show_url_in_emails'                => 'Nuoroda į AMS el. laiškuose',
    'show_url_in_emails_help_text'      => 'Atžymėkite šį langelį, jei nenorite, kad el. laiškų poraštėse būtų nuoroda į jūsų AMS diegimą. Naudinga, jei dauguma naudotojų niekada nesijungia prie sistemos. ',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Bus bandoma ištrinti talpykloje saugomus brūkšninius kodus. Įprastai, tai yra naudojama, tik jei pasikeitė brūkšninio kodo nustatymai arba pasikeitė AMS adresas. Brūkšniniai kodai bus sugeneruoti iš naujo, kai kitą kartą bus atidaryti.',
    ...
    'keywords' => [
        ...
        'notifications'     => 'įspėjimai, el. paštas, pranešimai, auditas, slenkstis, el. pašto įspėjimai, cc',
    ],
