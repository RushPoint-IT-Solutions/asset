...
return [
    ...
    'login' => '登录',
    'login_first_admin' => '请使用以下凭据登录新安装的 AMS：',
    ...
    'serial' => '序列号',
    'snipe_webhook_test' => 'AMS 集成测试',
    'snipe_webhook_summary' => 'AMS 集成测试摘要',
    'supplier' => '供应商',
    'tag' => '标签',
    'test_email' => 'AMS 测试邮件',
    'test_mail_text' => '这是一封 AMS 资产管理系统的测试电子邮件，如果您收到，表示邮件通知正常运作 :)',
    'the_following_item' => '以下项目已交回：',
    'to_reset' => '要重置 :web 的密码，请完成此表格：',
    'type' => '类型',
    'upcoming-audits' => '有:count 项资产将在:threshold 天内进行盘点.|有:count 项资产将在:threshold 天内进行盘点。',
    'user' => '用户',
    'username' => '用户名',
