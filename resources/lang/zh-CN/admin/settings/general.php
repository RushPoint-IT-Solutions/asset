...
'ldap_location_help'             => '如果 <strong>Base Bind DN 未指定组织单元 (OU)</strong>，则应使用 Ldap Location 字段来指定位置。 如果正在使用组织单元 (OU) 搜索，则请将此字段留空。',
    ...
    'ldap_display_name_help'    => '如果您在 LDAP/AD中有一个单独的 displayname 字段，在这里映射它，并且它将用于显示AMS中的用户。',
    ...
    'license'                   => '软件许可证',
    'load_remote'               => '加载远程头像',
    'load_remote_help_text'		=> '如果您的安装不能从外部网络加载脚本，请取消选中此项。 这将防止AMS 尝试从 Gravatar 或其他外部来源加载头像。',
    'login'                     => '登录尝试',
    'login_attempt'             => '登录尝试',
    'login_ip'                  => 'IP 地址',
    'login_success'             => '成功？',
    ...
    'login_remote_user_custom_logout_url_help' => '如果此处提供了URL，则在用户注销AMS后，用户将被重定向到此URL。这对于正确关闭身份验证提供程序的用户会话非常有用。',
    ...
    'show_images_in_email_help'   => '如果外部用户无法在邮件中通过你安装在VPN或内网的AMS加载图片，请取消此复选框。',
    'site_name'                 => '站点名称',
    'integrations'               => '集成',
    'slack'                     => 'Slack',
    ...
    'snipe_version'  			=> 'AMS 版本',
    'support_footer'            => '支持页脚链接 ',
    'support_footer_help'       => '指定谁可以看到指向AMS支持信息和用户手册的链接',
    'version_footer'            => '页脚中显示版本信息 ',
    'version_footer_help'       => '指定谁可以看到AMS版本和内部版本号。',
    'system'                    => '系统信息',
    'update'                    => '更新设置',
    'value'                     => '价值',
    'brand'                     => '品牌',
    ...
    'width_w'        => '宽',
    'height_h'        => '高',
    'show_url_in_emails'                => '在电子邮件中显示AMS链接',
    'show_url_in_emails_help_text'      => '如果您不希望在电子邮件页脚中显示AMS链接，请取消此框。如果您的大多数用户从未登录过系统，那么这项功能会很有作用。',
    'text_pt'        => '磅',
    ...
    'barcodes_help' => '这将尝试删除缓存条形码。 这通常只有在您的条码设置已经更改或您的AMS 链接已经更改时才使用。 下次访问时将重新生成条码。',
    ...
    'help_default_will_use' => '<code>:default</code> 将使用来自 <code>:setting_name</code>的值。 <br>请注意，条码的值必须符合各自的条码规范才能成功生成。详情请见 <a href="https://AMS.readme.io/docs/barcodes">文档 <i class="fa fa-external-link"></i></a> 了解更多细节。 ',
    'asset_id'              => '资产ID',
    'data'               => '数据',
    'default'               => '默认',
    'none'                  => '无',
