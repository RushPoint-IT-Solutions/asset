...
return [
    ...
    'login' => 'Είσοδος',
    'login_first_admin' => 'Συνδεθείτε στη νέα σας εγκατάσταση AMS χρησιμοποιώντας τα παρακάτω διαπιστευτήρια:',
    ...
    'serial' => 'Σειριακός',
    'snipe_webhook_test' => 'AMS Δοκιμή Ολοκλήρωσης',
    'snipe_webhook_summary' => 'Σύνοψη Δοκιμής Ενσωμάτωσης AMS',
    'supplier' => 'Προμηθευτές',
    'tag' => 'Ετικέτα',
    'test_email' => 'Έλεγχος email για AMS',
    'test_mail_text' => 'Πρόκειται για μια δοκιμή από το σύστημα διαχείρισης περιουσιακών στοιχείων της AMS. Αν το έχετε, το mail λειτουργεί :)',
    ...
    'your_credentials' => 'Τα διαπιστευτήρια σας AMS',
