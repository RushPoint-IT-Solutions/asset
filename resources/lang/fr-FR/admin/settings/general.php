...
'ldap_location_help'             => 'The LDAP Location field should be used if <strong>an OU is not being used in the Base Bind DN.</strong> Leave this blank if an OU search is being used.',
    ...
    'load_remote_help_text'		=> 'Décochez cette case si votre installation ne peut pas charger de scripts depuis internet. Cela empêchera AMS de tenter de charger les avatars depuis Gravatar ou toute autre source externe.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Si une URL est spécifiée ici, les utilisateurs seront redirigés vers cette URL après la déconnexion de AMS. Ceci est utile pour fermer correctement les sessions utilisateur de votre fournisseur d\'authentification.',
    ...
    'show_images_in_email_help'   => 'Décocher cette case si votre installation de AMS est derrière un VPN ou un réseau fermé et que les utilisateurs en dehors du réseau ne peuvent pas charger les images servies depuis cette installation dans leurs courriels.',
    ...
    'snipe_version'  			=> 'Version de AMS',
    'support_footer'            => 'Support des liens de pied de page ',
    'support_footer_help'       => 'Spécifiez qui voit les liens vers les manuels de support utilisateur AMS',
    'version_footer'            => 'Version en pied de page ',
    'version_footer_help'       => 'Spécifiez qui peut voir la version de AMS.',
    ...
    'width_w'        => 'l',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Lien vers AMS dans les e-mails',
    'show_url_in_emails_help_text'      => 'Décochez cette case si vous ne souhaitez pas relier votre installation AMS à vos pieds de page. Utile si la plupart de vos utilisateurs ne se connectent jamais.',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Cette opération essaiera de supprimer l\'ensemble des code-barres mis en cache. Cette opération n\'est utile que si les réglages de génération de code-barre ont été changés, ou si l\'URL de votre instance AMS a été modifiée. Les code-barres seront regénérés au prochain accès.',
