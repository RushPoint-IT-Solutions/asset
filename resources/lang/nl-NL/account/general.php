...
return array(
    ...
    'api_key_warning' => 'Bij het genereren van een API-token, zorg ervoor dat je deze direct kopieert, omdat deze daarna niet meer zichtbaar is.',
    'api_base_url' => 'Je API-basis-url bevindt zich op:',
    'api_base_url_endpoint' => '/&lt;endpoint&gt;',
    'api_token_expiration_time' => 'API tokens zijn ingesteld om te verlopen in:',
    'api_reference' => 'Controleer de <a href="https://AMS.readme.io/reference" target="_blank">API referentie</a> om specifieke API eindpunten en aanvullende API documentatie te vinden.',
    'profile_updated' => 'Account succesvol bijgewerkt',
