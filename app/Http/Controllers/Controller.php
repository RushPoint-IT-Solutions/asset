<?php
/*! \mainpage AMS Code Documentation
 *
 * \section intro_sec Introduction
 *
 * This documentation is designed to allow developers to easily understand
 * the backend code of AMS. Familiarity with the PHP language is assumed,
 ...
 * [Installation documentation](https://AMS.readme.io) for
 * information on how to install AMS.
 *
 * To learn how to set up a development environment and get started developing for AMS,
 * please see the [contributing documentation](https://AMS.readme.io/docs/contributing-overview).
 *
 * Only the AMS specific controllers, models, helpers, service providers,
